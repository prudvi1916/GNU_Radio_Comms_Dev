...
class am__demodulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "am__demodulation")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/poli-ubuntu-2404/sharingfiles/am_usrp710.dat', True, 0, 0)
...
def main(top_block_cls=am__demodulation, options=None):
