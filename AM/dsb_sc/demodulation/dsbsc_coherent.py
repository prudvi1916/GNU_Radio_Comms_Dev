...
class dsbsc_coherent(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "dsbsc_coherent")
        ...
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_ff(0.1)
        ...
        self.analog_sig_source_x_1_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fc, 1, 0, 90)
        self.analog_sig_source_x_1_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fc, 1, 0, 0)
        ...
        self.connect((self.blocks_add_xx_1, 0), (self.blocks_throttle2_0_0_0, 0))
        ...
        self.connect((self.blocks_throttle2_0_0_0, 0), (self.blocks_multiply_xx_1, 0))
        self.connect((self.low_pass_filter_0_0, 0), (self.blocks_multiply_const_vxx_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 1000, 1000, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=dsbsc_coherent, options=None):
