...
class am_modulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fm_range = qtgui.Range(0, 500, 50, 500, 200)
        ...
        self._fc_range = qtgui.Range(0, 1000, 100, 100, 200)
        ...
        self.blocks_throttle2_0_0_0_1 = blocks.throttle( gr.sizeof_float*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_throttle2_0_0_0_0 = blocks.throttle( gr.sizeof_float*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        ...
        self.analog_sig_source_x_1_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fc, 1, 0, 0)
        self.analog_sig_source_x_1_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, fc, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_0, 0), (self.blocks_throttle2_0_0_0_0, 0))
        self.connect((self.analog_sig_source_x_1, 0), (self.blocks_multiply_xx_0, 1))
        self.connect((self.analog_sig_source_x_1_0, 0), (self.blocks_complex_to_float_0_0_0, 0))
        self.connect((self.analog_sig_source_x_1_1, 0), (self.blocks_multiply_xx_0_1, 1))
        self.connect((self.blocks_add_xx_0_0, 0), (self.blocks_sub_xx_0, 1))
        ...
        self.connect((self.blocks_complex_to_float_0_0_0, 0), (self.blocks_multiply_xx_0_0, 1))
        self.connect((self.blocks_complex_to_float_0_0_0, 1), (self.blocks_multiply_xx_0_0_0, 1))
        ...
        self.connect((self.blocks_sub_xx_0, 0), (self.blocks_throttle2_0_0_0, 0))
        self.connect((self.blocks_throttle2_0, 0), (self.blocks_sub_xx_0, 0))
        self.connect((self.blocks_throttle2_0_0_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.blocks_throttle2_0_0_0_0, 0), (self.hilbert_fc_0, 0))
        self.connect((self.blocks_throttle2_0_0_0_0, 0), (self.hilbert_fc_1, 0))
        self.connect((self.blocks_throttle2_0_0_0_1, 0), (self.blocks_multiply_const_vxx_0_0, 0))
        ...
        self.connect((self.low_pass_filter_0, 0), (self.blocks_throttle2_0_0_0_1, 0))
