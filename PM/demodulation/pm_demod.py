...
class dsbsc_gnuradio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "dsbsc_gnuradio")
        ...
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_cc(-mi)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, fc, 1, 0, 0)
        self.analog_sig_source_x_0_1 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, fm, 1, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, fm, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, fm, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_1, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.analog_sig_source_x_0_1, 0), (self.qtgui_time_sink_x_0_0, 0))
        ...
        self.connect((self.blocks_integrate_xx_0, 0), (self.blocks_throttle2_0_0_0_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.blocks_add_const_vxx_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0_0, 0), (self.blocks_add_const_vxx_0_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0_0_0, 0), (self.blocks_add_xx_1, 1))
        ...
        self.connect((self.blocks_throttle2_0_0, 0), (self.blocks_multiply_const_vxx_0_0_0, 0))
        self.connect((self.blocks_throttle2_0_0_0_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.blocks_throttle2_0_0_0_0, 0), (self.qtgui_time_sink_x_0, 0))
    ...
    def set_mi(self, mi):
        ...
        self.blocks_multiply_const_vxx_0_0.set_k(-self.mi)
...
def main(top_block_cls=dsbsc_gnuradio, options=None):
