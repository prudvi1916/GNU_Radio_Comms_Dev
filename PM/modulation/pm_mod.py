...
class dsbsc_gnuradio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_ff((-mi))
        ...
        self.analog_sig_source_x_1_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, fc, 1, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, fc, 1, 0, 0)
        self.analog_sig_source_x_0_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fm, 1, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, fm, 1, 0, 0)
        ...
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_throttle2_0_0_0_0, 0))
